...
class __TwigTemplate_fec97a92f90eace474c9d8fc80b373e02cfce403a09a9d6a4a0747d524ea9d18 extends Template
{
    private $source;
    private $macros = [];
...
";
            ...
            <ul class=\"dropdown-sub-menu dropdown-menu\">
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
                    ...
                    foreach ($context['_seq'] as $context["step"] => $context["indexItem"]) {
                        ...
                        // line 82
                        yield "                                ";
                        if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["indexItem"], "stepStatus", [], "any", false, true, true, 82), "index-item-unanswered", [], "any", true, true, true, 82) && (0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["indexItem"], "stepStatus", [], "any", false, false, true, 82), "index-item-unanswered", [], "any", false, false, true, 82), true)))) {
                            // line 83
                            yield "                                    ";
                        ...
                        // line 85
                        yield "                                ";
                        if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["indexItem"], "stepStatus", [], "any", false, true, true, 85), "index-item-error", [], "any", true, true, true, 85) && (0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["indexItem"], "stepStatus", [], "any", false, false, true, 85), "index-item-error", [], "any", false, false, true, 85), true)))) {
                            // line 86
                            yield "                                    ";
                ...
                // line 101
                yield "                ";
                if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "aQuestionIndex", [], "any", false, false, true, 101), "type", [], "any", false, false, true, 101), "full"))) {
                    // line 102
                    yield "                    <li>
                        ";
                    // line 103
    ...
    {
        return new Source("", "./subviews/navigation/question_index_menu.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/vanilla/views/subviews/navigation/question_index_menu.twig");
    }
