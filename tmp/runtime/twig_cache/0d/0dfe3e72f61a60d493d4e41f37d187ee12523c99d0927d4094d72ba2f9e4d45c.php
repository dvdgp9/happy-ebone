...
/* __string_template__42377b1f0c19359be57c0499835c2e5a37031207b39aefa30e649ae42101bb25 */
class __TwigTemplate_122aef5685884caf6bea35b3951cd69bed93bcde4b7d793ad5a0f2dfe32a65f4 extends Template
{
    private $source;
    private $macros = [];
...
<body
    class=\" ";
        ...
        yield " ";
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 95), "brandlogo", [], "any", false, false, true, 95), "on"))) {
            yield "brand-logo";
        }
        yield "\" ";
...
";
    ...
    {
        return "__string_template__42377b1f0c19359be57c0499835c2e5a37031207b39aefa30e649ae42101bb25";
    }
    ...
    {
        return new Source("", "__string_template__42377b1f0c19359be57c0499835c2e5a37031207b39aefa30e649ae42101bb25", "");
    }
