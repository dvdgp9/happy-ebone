...
class __TwigTemplate_ec183de5f7a4b2ae45653170ea5e073e81ef23d0be351f8ae7dcac0f1ac01229 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 39
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "upload_file", [], "any", false, false, true, 39), true))) {
            // line 40
            yield "    ";
...
";
    ...
    {
        return new Source("", "./subviews/header/start_form.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/fruity_twentythree/views/subviews/header/start_form.twig");
    }
