...
class __TwigTemplate_75ab90d26d997ba0435a16b2b11a42d8bdc62ec182aebdc8aef1df975b4415cf extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 25
        if ((0 === CoreExtension::compare(empty(LS_Twig_Extension::json_decode(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "jPopup", [], "any", false, false, true, 25))), false))) {
            // line 26
            yield "    ";
...
";
    ...
    <div class=\"";
        ...
        <div class=\"";
            ...
            ";
            // line 41
            if (((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "mandNonSoft", [], "any", false, false, true, 41), false)) && CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "mandSoft", [], "any", false, false, true, 41))) {
                // line 42
                yield "            <div class=\"";
                ...
                <script>
                    ";
                // line 45
                if ((1 === CoreExtension::compare(intval(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 45), "showpopups", [], "any", false, false, true, 45)), 0))) {
...
";
    ...
    {
        return new Source("", "./subviews/messages/bootstrap_alert_modal.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/vanilla/views/subviews/messages/bootstrap_alert_modal.twig");
    }
