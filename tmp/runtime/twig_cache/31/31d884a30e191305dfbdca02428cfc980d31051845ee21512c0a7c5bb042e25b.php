...
class __TwigTemplate_a5dd1a2ca60c21a1c9da57d342d8c77809c5e415b81b1c0c34ddbf898df65ba0 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"";
        ...
        <div class=\"";
            ...
            ";
            // line 42
            if (((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "mandNonSoft", [], "any", false, false, true, 42), false)) && CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "mandSoft", [], "any", false, false, true, 42))) {
                // line 43
                yield "            <div class=\"";
...
<div id=\"clear-all-modal\" class=\"modal\" tabindex=\"-1\">
    ...
    {
        return new Source("", "./subviews/messages/bootstrap_alert_modal.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/fruity_twentythree/views/subviews/messages/bootstrap_alert_modal.twig");
    }
