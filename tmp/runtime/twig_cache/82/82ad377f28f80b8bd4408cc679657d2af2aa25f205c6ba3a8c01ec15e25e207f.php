...
class __TwigTemplate_4fdf48da43a4e98520a746deca09b84809863936ed23ad1d5ec5f4c3fd51ffeb extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        // line 9
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "aNavigator", [], "any", false, false, true, 9), "save", [], "any", false, false, true, 9), "show", [], "any", false, false, true, 9), "Y"))) {
            // line 10
            yield "<button ";
...
";
    ...
    {
        return new Source("", "./subviews/navigation/save_buttons.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/vanilla/views/subviews/navigation/save_buttons.twig");
    }
