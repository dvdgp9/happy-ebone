...
class __TwigTemplate_614087f5caead2984914fdca52536f6a891c602dc1ac5124263721f4547cd0db extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"";
        ...
        ";
        // line 46
        if ((1 === CoreExtension::compare(LS_Twig_Extension::safecount(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "aLoadForm", [], "any", false, false, true, 46), "aErrors", [], "any", false, false, true, 46)), 0))) {
            // line 47
            yield "            <ul class=\"";
...
";
    ...
    {
        return new Source("", "./subviews/content/load.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/fruity_twentythree/views/subviews/content/load.twig");
    }
