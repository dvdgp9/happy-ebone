...
class __TwigTemplate_9e6864b4686d671d20184f75e666219d1a7f9e8d3cfc537f9e843041294b3040 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 20
        if ((((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "showprogress", [], "any", false, false, true, 20), "Y")) && (0 !== CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "format", [], "any", false, false, true, 20), "A"))) &&  !CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "aCompleted", [], "any", false, false, true, 20))) {
            // line 21
            yield "    <!-- Top container -->
    <div class=\"";
            // line 22
...
";
    ...
    {
        return new Source("", "./subviews/header/progress_bar.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/vanilla/views/subviews/header/progress_bar.twig");
    }
