...
class __TwigTemplate_56c475e2d386b98f41fe7c72526a55a3d2ca647e16215f1f9dadd6041ef1c1c2 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"";
    ...
    <div class=\"";
        ...
        if (( !CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "popupPreview", [], "any", false, false, true, 42) && CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aNavigator"] ?? null), "aMoveNext", [], "any", false, false, true, 42), "show", [], "any", false, false, true, 42))) {
            ...
            // line 45
            yield "            ";
            if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aNavigator"] ?? null), "aMoveNext", [], "any", false, false, true, 45), "value", [], "any", false, false, true, 45), "movesubmit"))) {
                // line 46
                yield "                <!-- Button submit -->
                <button ";
                // line 47
...
";
    ...
    {
        return new Source("", "./subviews/navigation/navigator.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/vanilla/views/subviews/navigation/navigator.twig");
    }
