...
class __TwigTemplate_fc381dd4e9eb39d8017ef776b01f285e824ec93e489070cdf6953ea0ada890da extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 21
        if (((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aGroup"] ?? null), "showgroupinfo", [], "any", false, false, true, 21), "D")) || (0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aGroup"] ?? null), "showgroupinfo", [], "any", false, false, true, 21), "B")))) {
            // line 22
            yield "    ";
            if ((0 !== CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aGroup"] ?? null), "description", [], "any", false, false, true, 22), ""))) {
                // line 23
    ...
    {
        return new Source("", "./subviews/survey/group_subviews/group_desc.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/fruity_twentythree/views/subviews/survey/group_subviews/group_desc.twig");
    }
