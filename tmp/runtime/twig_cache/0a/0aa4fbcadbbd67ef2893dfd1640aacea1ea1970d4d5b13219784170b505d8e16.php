...
class __TwigTemplate_151329844252da4c128853dbfadb6d03119d7ff2768b36c9286ff45d1d64c4c6 extends Template
{
    private $source;
    private $macros = [];
...
<div id=\"";
    ...
    <div class=\"";
        ...
        // line 47
        yield "            ";
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "bShowxquestions", [], "any", false, false, true, 47), true))) {
            // line 48
            yield "                ";
            if ((-1 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "iTotalquestions", [], "any", false, false, true, 48), 1))) {
                // line 49
                yield "                    ";
...
";
    ...
    {
        return new Source("", "./subviews/messages/welcome.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/vanilla/views/subviews/messages/welcome.twig");
    }
