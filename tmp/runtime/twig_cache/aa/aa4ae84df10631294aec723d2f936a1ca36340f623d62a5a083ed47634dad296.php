...
class __TwigTemplate_83cacd8f2c5d3ffb7c470b16d2b41b44a713d1a1fb0566027c03d1d2a0bf41a5 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"";
    ...
    ";
        // line 41
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aGroup"] ?? null), "show_last_group", [], "any", false, false, true, 41), true))) {
            // line 42
    ...
    ";
        // line 45
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aGroup"] ?? null), "show_last_answer", [], "any", false, false, true, 45), true))) {
            // line 46
...
";
    ...
    {
        return new Source("", "./subviews/survey/group_subviews/group_container.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/fruity_twentythree/views/subviews/survey/group_subviews/group_container.twig");
    }
