...
class __TwigTemplate_d82ecc2492aa241206e9139d09785177d81af9efcdaf4e561ea23accf2c39e8c extends Template
{
    private $source;
    private $macros = [];
...
<head>
    ...
    ";
        // line 44
        if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 44), "fixnumauto", [], "any", false, false, true, 44) && (0 !== CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 44), "fixnumauto", [], "any", false, false, true, 44), "off")))) {
            // line 45
            yield "        ";
            yield LS_Twig_Extension::registerScript("LSvarTemplateRealFixNumAuto", (("LSvar.bFixNumAuto = " . (((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 45), "fixnumauto", [], "any", false, false, true, 45), "enable"))) ? (1) : (0))) . ";"), "POS_HEAD");
            yield "
        ";
            // line 46
            yield LS_Twig_Extension::registerScript("LSvarTemplateRealNumRealValue", (("LSvar.bNumRealValue = " . (((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 46), "fixnumauto", [], "any", false, false, true, 46), "disable"))) ? (1) : (0))) . ";"), "POS_HEAD");
            yield "
    ";
        }
        // line 48
...
";
    ...
    {
        return new Source("", "./subviews/header/head.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/fruity_twentythree/views/subviews/header/head.twig");
    }
