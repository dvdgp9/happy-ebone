...
class __TwigTemplate_4f8b1e7214bd634316ad158d3150124c4c6e59ca4be03760024e1f2a95f6d10c extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 28
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "aQuestionIndex", [], "any", false, false, true, 28), "bShow", [], "any", false, false, true, 28), true))) {
            // line 29
            yield "    ";
            if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "format", [], "any", false, false, true, 29), "G"))) {
                // line 30
        ...
        <li class=\"dropdown nav-item ls-no-js-hidden index-menu-";
            ...
            <ul id=\"index-dropdown\" class=\"dropdown-menu dropdown-menu-end\">
                ...
                foreach ($context['_seq'] as $context["step"] => $context["indexItem"]) {
                    ...
                    // line 44
                    yield "                    ";
                    if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["indexItem"], "stepStatus", [], "any", false, true, true, 44), "index-item-error", [], "any", true, true, true, 44) && (0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["indexItem"], "stepStatus", [], "any", false, false, true, 44), "index-item-error", [], "any", false, false, true, 44), true)))) {
                        // line 45
                        yield "                        ";
                    ...
                    // line 47
                    yield "                    ";
                    if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["indexItem"], "stepStatus", [], "any", false, true, true, 47), "index-item-current", [], "any", true, true, true, 47) && (0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["indexItem"], "stepStatus", [], "any", false, false, true, 47), "index-item-current", [], "any", false, false, true, 47), true)))) {
                        // line 48
                        yield "                        ";
    ...
    ";
            // line 62
            yield "    ";
            if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "format", [], "any", false, false, true, 62), "S"))) {
                // line 63
            ...
            <ul class=\"dropdown-menu dropdown-menu-end\">
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
                    ...
                    foreach ($context['_seq'] as $context["step"] => $context["indexItem"]) {
                        ...
                        // line 81
                        yield "                                ";
                        if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["indexItem"], "stepStatus", [], "any", false, true, true, 81), "index-item-unanswered", [], "any", true, true, true, 81) && (0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["indexItem"], "stepStatus", [], "any", false, false, true, 81), "index-item-unanswered", [], "any", false, false, true, 81), true)))) {
                            // line 82
                            yield "                                    ";
                        ...
                        // line 84
                        yield "                                ";
                        if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["indexItem"], "stepStatus", [], "any", false, true, true, 84), "index-item-error", [], "any", true, true, true, 84) && (0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["indexItem"], "stepStatus", [], "any", false, false, true, 84), "index-item-error", [], "any", false, false, true, 84), true)))) {
                            // line 85
                            yield "                                    ";
                        ...
                        // line 87
                        yield "                                ";
                        if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["indexItem"], "stepStatus", [], "any", false, true, true, 87), "index-item-current", [], "any", true, true, true, 87) && (0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["indexItem"], "stepStatus", [], "any", false, false, true, 87), "index-item-current", [], "any", false, false, true, 87), true)))) {
                            // line 88
                            yield "                                    ";
                ...
                // line 98
                yield "                ";
                if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "aQuestionIndex", [], "any", false, false, true, 98), "type", [], "any", false, false, true, 98), "full"))) {
                    // line 99
    ...
    {
        return new Source("", "./subviews/navigation/question_index_menu.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/fruity_twentythree/views/subviews/navigation/question_index_menu.twig");
    }
