...
class __TwigTemplate_66ffbd99ae161509e168807387bd2e167146380e21f6b0b5c589dd78b6faa695 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"";
    ...
    <div class=\"col-12 col-centered ";
        ...
        ";
        // line 23
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 23), "hideprivacyinfo", [], "any", false, false, true, 23), "off"))) {
            // line 24
            yield "            ";
...
";
    ...
    public function block_anonymous($context, array $blocks = [])
    {
        ...
        // line 25
        yield "                ";
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "anonymized", [], "any", false, false, true, 25), "Y"))) {
            // line 26
    ...
    public function block_datasecurity($context, array $blocks = [])
    {
        ...
        // line 43
        yield "            ";
        if ((0 !== CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "format", [], "any", false, false, true, 43), "A"))) {
            // line 44
            yield "                ";
            if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "showsurveypolicynotice", [], "any", false, false, true, 44), 1))) {
                // line 45
                yield "                    ";
...
($context["aSurveyInfo"] ?? null), "showsurveypolicynotice", [], "any", false, false, true, 46), 2))) {
    ...
    {
        return new Source("", "./subviews/privacy/privacy.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/fruity_twentythree/views/subviews/privacy/privacy.twig");
    }
