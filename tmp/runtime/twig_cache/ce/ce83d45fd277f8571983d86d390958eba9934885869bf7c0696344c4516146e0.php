...
class __TwigTemplate_c2346f364b038b1d37beb8d296b31f3d9796a40b6998b339d4774cbb2f29b445 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 20
        if (((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 20), "backgroundimage", [], "any", false, false, true, 20), "on")) && LS_Twig_Extension::imageSrc(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 20), "backgroundimagefile", [], "any", false, false, true, 20)))) {
            // line 21
            yield "        body {
    ...
    ";
        // line 33
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 33), "brandlogo", [], "any", false, false, true, 33), "on"))) {
            // line 34
    ...
    ";
        // line 55
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 55), "animatecheckbox", [], "any", false, false, true, 55), "on"))) {
            // line 56
            yield "
        ";
            // line 57
            if ((-1 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 57), "checkboxanimationduration", [], "any", false, false, true, 57), 1))) {
                // line 58
                yield "            ";
    ...
    ";
        // line 83
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 83), "animateradio", [], "any", false, false, true, 83), "on"))) {
            // line 84
            yield "
        ";
            // line 85
            if ((-1 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 85), "radioanimationduration", [], "any", false, false, true, 85), 1))) {
                // line 86
                yield "            ";
    ...
    ";
        // line 111
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 111), "animatequestion", [], "any", false, false, true, 111), "on"))) {
            // line 112
            yield "
        ";
            // line 113
            if ((-1 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 113), "questionanimationduration", [], "any", false, false, true, 113), 1))) {
                // line 114
                yield "            ";
    ...
    ";
        // line 126
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 126), "animatealert", [], "any", false, false, true, 126), "on"))) {
            // line 127
            yield "
        ";
            // line 128
            if ((-1 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 128), "alertanimationduration", [], "any", false, false, true, 128), 1))) {
                // line 129
                yield "            ";
    ...
    ";
        // line 141
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 141), "animatebody", [], "any", false, false, true, 141), "on"))) {
            // line 142
            yield "
        ";
            // line 143
            if ((-1 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 143), "bodyanimationduration", [], "any", false, false, true, 143), 1))) {
                // line 144
                yield "            ";
...
";
    ...
    {
        return new Source("", "./subviews/header/custom_header.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/fruity_twentythree/views/subviews/header/custom_header.twig");
    }
