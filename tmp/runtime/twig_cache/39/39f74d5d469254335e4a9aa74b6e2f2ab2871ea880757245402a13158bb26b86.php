...
/* __string_template__0378bea5d63dd83efe3f6314e7a5fc1d70ee7a9ceb5aa24b37cb44e8e94194ea */
class __TwigTemplate_4ae2ecf0e323a0fd6959f7148c6e81da3df70fbd0191022cd7c4f42ecc8c7a56 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        $context["scale_id"] = 0;
        // line 7
        $context["supportsRelevance"] = (0 !== CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["question"] ?? null), "questionType", [], "any", false, false, true, 7), "code", [], "any", false, false, true, 7), "H"));
        // line 8
        yield "
...
";
        ...
        ";
            ...
            ";
                ...
                // line 17
                yield "            ";
                if ((1 === CoreExtension::compare(($context["scalecount"] ?? null), 1))) {
                    // line 18
                    yield "                ";
                    if ((0 === CoreExtension::compare($context["scale_id"], 0))) {
                        // line 19
            ...
            > </i>
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["subquestion"]) {
                    ...
                    yield "                            <!-- Line tag -->
                            ";
                    // line 71
                    yield from                     $this->loadTemplate("subquestionRow.twig", "__string_template__0378bea5d63dd83efe3f6314e7a5fc1d70ee7a9ceb5aa24b37cb44e8e94194ea", 71)->unwrap()->yield(CoreExtension::merge($context, ["position" =>                     // line 72
...
($context["question"] ?? null), "gid", [], "any", false, false, true, 136), 136, $this->source)]);
    ...
    data-assessmentvisible=\"";
        // line 139
        if ((0 === CoreExtension::compare(($context["assessmentvisible"] ?? null), true))) {
            yield "1";
        } else {
            yield "0";
        }
...
";
    ...
    {
        return "__string_template__0378bea5d63dd83efe3f6314e7a5fc1d70ee7a9ceb5aa24b37cb44e8e94194ea";
    }
    ...
    {
        return new Source("", "__string_template__0378bea5d63dd83efe3f6314e7a5fc1d70ee7a9ceb5aa24b37cb44e8e94194ea", "");
    }
