...
class __TwigTemplate_8cace67f22d92a687e311c8f1adfb8003a9112ab27a0139f9f687062798c9e78 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 29
        if (((0 !== CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "active", [], "any", false, false, true, 29), "Y")) &&  !CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "popupPreview", [], "any", false, false, true, 29))) {
            // line 30
    ...
    <div class=\"";
            ...
            yield " row alert alert-warning alert-dismissible fade in show alert-dismissible\" ";
...
";
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "errorHtml", [], "any", false, false, true, 38), "show", [], "any", false, false, true, 38)) {
            // line 39
            yield "    <p class=' ";
            yield " row fade in show alert-dismissible alert alert-danger ";
...
";
    ...
    {
        return new Source("", "./subviews/messages/warnings.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/vanilla/views/subviews/messages/warnings.twig");
    }
