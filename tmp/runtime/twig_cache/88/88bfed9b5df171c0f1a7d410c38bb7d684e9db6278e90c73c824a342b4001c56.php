...
class __TwigTemplate_44f8a529e68a5de3d3a1fdb792902be2e11ed8a0b1d6df82b75b759064ffb75d extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 26
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "alanguageChanger", [], "any", false, false, true, 26), "show", [], "any", false, false, true, 26), true))) {
            // line 27
            yield "
    ";
            // line 29
...
";
    ...
    {
        return new Source("", "./subviews/navigation/language_changer_top_menu.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/fruity_twentythree/views/subviews/navigation/language_changer_top_menu.twig");
    }
