...
class __TwigTemplate_2098d79269a140bac18f916b0b510ba802b0be57dcdd257c80a96908b6382fd1 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (((CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "googleanalyticsapikey", [], "any", true, true, true, 17) && CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "googleanalyticsapikey", [], "any", false, false, true, 17)) && CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "googleanalyticsstyle", [], "any", false, false, true, 17))) {
            ...
            if ((is_string($__internal_compile_0 = CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "googleanalyticsapikey", [], "any", false, false, true, 19)) && is_string($__internal_compile_1 = "UA-") && str_starts_with($__internal_compile_0, $__internal_compile_1))) {
                ...
                // line 21
                yield "        ";
                if ((CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "googleanalyticsstyle", [], "any", true, true, true, 21) && (0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "googleanalyticsstyle", [], "any", false, false, true, 21), 1)))) {
                    // line 22
                    yield "            <script>
        ...
        <script>
            ...
            ";
                // line 54
                if ( !(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "googleanalyticsstyle", [], "any", true, true, true, 54) && (0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "googleanalyticsstyle", [], "any", false, false, true, 54), 1)))) {
                    // line 55
                    yield "                ";
    ...
    {
        return new Source("", "./subviews/header/google_analytics.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/fruity_twentythree/views/subviews/header/google_analytics.twig");
    }
