...
class __TwigTemplate_220e6d9fc89d5bea0d8eddf847f2c446301901b2a3c13d95193fedf26ebe4cf1 extends Template
{
    private $source;
    private $macros = [];
...
<div id=\"";
    ...
    <div class=\"";
        ...
        // line 45
        yield "            ";
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "bShowxquestions", [], "any", false, false, true, 45), true))) {
            // line 46
            yield "                ";
            if ((-1 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "iTotalquestions", [], "any", false, false, true, 46), 1))) {
                // line 47
                yield "                    ";
...
";
    ...
    {
        return new Source("", "./subviews/messages/welcome.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/fruity_twentythree/views/subviews/messages/welcome.twig");
    }
