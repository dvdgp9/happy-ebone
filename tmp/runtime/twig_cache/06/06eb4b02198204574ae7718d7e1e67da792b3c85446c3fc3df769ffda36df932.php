...
class __TwigTemplate_24a370bea981aab8d5aade69bfae6bcbadb8b798c8cdadaafe162fc9edc84c32 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 39
        yield "    ";
        if ((0 !== CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 39), "questionhelptextposition", [], "any", false, false, true, 39), "bottom"))) {
            // line 40
            yield "        ";
    ...
    ";
        // line 50
        yield "    ";
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 50), "questionhelptextposition", [], "any", false, false, true, 50), "bottom"))) {
            // line 51
            yield "        ";
            yield Twig\Extension\CoreExtension::include($this->env, $context, "./subviews/survey/question_subviews/survey_question_help.twig");
            yield "
...
";
    ...
    {
        return new Source("", "./subviews/survey/question.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/fruity_twentythree/views/subviews/survey/question.twig");
    }
