...
class __TwigTemplate_8bd545d70e717a0e058c916f5921c1c422d61cf02ef82177645a24ef55da637c extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_endtext($context, array $blocks = [])
    {
        ...
        // line 35
        yield "            ";
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "aCompleted", [], "any", false, false, true, 35), "showDefault", [], "any", false, false, true, 35), true))) {
            // line 36
            yield "                <p class=\"";
    ...
    public function block_publicstatistics($context, array $blocks = [])
    {
        ...
        // line 64
        yield "            ";
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "aCompleted", [], "any", false, false, true, 64), "aPublicStatistics", [], "any", false, false, true, 64), "show", [], "any", false, false, true, 64), true))) {
            // line 65
    ...
    {
        return new Source("", "./subviews/content/submit.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/fruity_twentythree/views/subviews/content/submit.twig");
    }
