...
class __TwigTemplate_65517b408903415f87c391c82133aa6389384004cf2001005247826102648f87 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"";
        ...
        ";
        // line 59
        if ((1 === CoreExtension::compare(LS_Twig_Extension::safecount(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "aSaveForm", [], "any", false, false, true, 59), "aErrors", [], "any", false, false, true, 59)), 0))) {
            // line 60
            yield "            <ul class='";
...
";
    ...
    {
        return new Source("", "./subviews/content/save.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/fruity_twentythree/views/subviews/content/save.twig");
    }
