...
class __TwigTemplate_ee93bce2df75dec481f23117f44b51436c2cd49cd9940bb67e0bf62857acbbb9 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"";
        ...
        yield "  ";
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "options", [], "any", false, false, true, 21), "container", [], "any", false, false, true, 21), "on"))) {
            yield " container-md ";
        } else {
...
";
    ...
    {
        return new Source("", "./subviews/content/outerframe.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/vanilla/views/subviews/content/outerframe.twig");
    }
