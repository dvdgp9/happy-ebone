...
class __TwigTemplate_f6080df2b83c15de5a8cc8ec8e31417ff387da7a5397b922153a04d5b0b43911 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"";
    ...
    <ul class=\"list-unstyled col-12 col-md-";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["aRow"]) {
            // line 20
            yield "            ";
            if (((0 == CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index0", [], "any", false, false, true, 20) % ($context["iMaxRowsByColumn"] ?? null)) && (0 !== CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index0", [], "any", false, false, true, 20), 0)))) {
                // line 21
                yield "                </ul>
                <ul class=\"list-unstyled col-12 col-md-";
                // line 22
