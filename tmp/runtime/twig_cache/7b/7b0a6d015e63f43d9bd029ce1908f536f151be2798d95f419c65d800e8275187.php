...
class __TwigTemplate_cbc158342a7abae5db8bbcfff728ff3fbac32795b0ec3f1cfce8060ae472b977 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_datasecurity($context, array $blocks = [])
    {
        ...
        // line 45
        yield "            ";
        if ((0 !== CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "format", [], "any", false, false, true, 45), "A"))) {
            // line 46
            yield "                ";
            if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["aSurveyInfo"] ?? null), "showsurveypolicynotice", [], "any", false, false, true, 46), 1))) {
                // line 47
                yield "                    ";
...
($context["aSurveyInfo"] ?? null), "showsurveypolicynotice", [], "any", false, false, true, 48), 2))) {
    ...
    {
        return new Source("", "./subviews/privacy/privacy.twig", "/var/www/vhosts/ebone.es/happy.ebone.es/limesurvey/themes/survey/vanilla/views/subviews/privacy/privacy.twig");
    }
